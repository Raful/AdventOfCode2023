...
public class Day2Part2Tests
{
    ...
    public void Game1()
    {
        ...
        Assert.AreEqual(48, Day2.ParseSingleLinePart2(input));
    }
    [Test]
    public void Game2()
    {
        ...
        Assert.AreEqual(12, Day2.ParseSingleLinePart2(input));
    }
    [Test]
    public void Game3()
    {
        ...
        Assert.AreEqual(1560, Day2.ParseSingleLinePart2(input));
    }
    [Test]
    public void Game4()
    {
        ...
        Assert.AreEqual(630, Day2.ParseSingleLinePart2(input));
    }
    [Test]
    public void Game5()
    {
        ...
        Assert.AreEqual(36, Day2.ParseSingleLinePart2(input));
    }
    [Test]
    public void MaxValues()
    {
        ...
        Assert.AreEqual(12*13*14, Day2.ParseSingleLinePart2(input));
    }
    [Test]
    public void OverValues()
    {
        ...
        Assert.AreEqual(13*14*15, Day2.ParseSingleLinePart2(input));
    }
    [Test]
    public void TestProvidedExample()
    {
        ...
        Assert.AreEqual(2286, Day2.ExecutePart2(input));
    }
}
